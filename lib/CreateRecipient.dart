            ...
            children: <Widget>[
              Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    PaddingWith(top: 2.0, left: 5.0,right: 5.0,widget:MyTextField(type: TextInputType.text,formOk:(val) {return (val.isEmpty) ? "Entrer un nom":null;},controller: _Cname, hint: "Nom", color1: black, color2: base, color3: base, color4: Colors.grey, icon: Icon(Icons.person), color5: base, color6: Colors.grey,),),
                    PaddingWith(top: 5.0, left: 5.0,right: 5.0,widget:MyTextField(type: TextInputType.text,formOk:(val) {return (val.isEmpty) ? "Entrer un prenom":null;},controller: _Csurname, hint: "Prénom",color1: black, color2: base, color3: base, color4: Colors.grey, icon: Icon(Icons.person), color5: base, color6: Colors.grey,),),
                    PaddingWith(top: 5.0, left: 5.0,right: 5.0,widget:MyTextField(type: TextInputType.text,formOk:(val) {return null;},controller: _Caddress, hint: "Adresse",color1: black, color2: base, color3: base, color4: Colors.grey, icon: Icon(Icons.add_location), color5: base, color6: Colors.grey,),),
