...
import 'package:money_transfert/empty_screen.dart';
...
import 'package:money_transfert/transaction_details.dart';
...
class TransactionPages extends StatefulWidget{
  @override
  _TransactionPages createState()=>new _TransactionPages();
}

class _TransactionPages extends State<TransactionPages>{
                                ...
                                children: <Widget>[
                                  ...
                                  ListTile(
                                    ...
                                    trailing: Wrap(
                                      ...
                                      children: <Widget>[
                                        MyText(
                                          "${double.parse(transaction.amountSend.replaceAll(',', '')).toString().replaceAllMapped(reg, mathFunc)} "+CurrencyPickerUtils.getCountryByIsoCode(CountryPickerUtils.getCountryByName(me.country).isoCode).currencyCode,
                                          color: black,
                                          weight: FontWeight.w500,
